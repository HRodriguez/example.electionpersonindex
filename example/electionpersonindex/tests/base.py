...
def setup_product():
    ...
    import example.electionpersonindex
    zcml.load_config('configure.zcml', example.electionpersonindex)
    ...
    ztc.installPackage('example.electionpersonindex')
...
setup_product()
ptc.setupPloneSite(products=['example.electionpersonindex'])
